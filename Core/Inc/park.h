...
static inline void _clarke_calc_2(svpwm_t* v) {
    ...
    v->Alpha = v->As;
    v->Beta = ((v->As + (v->Bs * 2)) * _onebysqrt3)/1000;
}
...
static inline void _clarke_calc_3(svpwm_t* v) {
    ...
    v->Alpha = v->As;
    v->Beta = ((v->Bs - v->Cs) * _onebysqrt3)/1000;
#elif (CLARK_3_current == 0)
    v->Alpha = ((2 * v->As - v->Bs - v->Cs) * _onebythree)/1000;
    v->Beta = ((v->Bs - v->Cs) * _onebysqrt3)/1000;
#endif
}
...
//     DateType Bs;     //!< Input: phase-b stator variable
//     DateType Cs;     //!< Input: phase-c stator variable
//     DateType Alpha;  //!< Output: stationary d-axis stator variable
//     DateType Beta;   //!< Output: stationary q-axis stator variable
// } clarke_t;
// /*-----------------------------------------------------------------------------
//     PARK 变换 结构体
// -----------------------------------------------------------------------------*/
// typedef struct {
//     DateType Alpha;  //!< Input: stationary d-axis stator variable
//     DateType Beta;   //!< Input: stationary q-axis stator variable
//     DateType Angle;  //!< Input: rotating angle (pu)
//     DateType Ds;     //!< Output: rotating d-axis stator variable
//     DateType Qs;     //!< Output: rotating q-axis stator variable

//     DateType Sine;    //!< Input: Sine term
//     DateType Cosine;  //!< Input: Cosine term
// } park_t;
...
//     DateType Beta;   //!< Output: stationary q-axis stator variable
//     DateType Angle;  //!< Input: rotating angle (pu)
//     DateType Ds;     //!< Input: rotating d-axis stator variable
//     DateType Qs;     //!< Input: rotating q-axis stator variable
